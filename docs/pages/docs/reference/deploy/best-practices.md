...
generate so `go run github.com/vnsoft2014/prisma-client-go generate` and any other generate commands you run will get
executed.

Put this line into a Go file in your project, usually in `main.go`:

```go
//go:generate go run github.com/vnsoft2014/prisma-client-go generate
