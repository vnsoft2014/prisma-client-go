...
export default {
  ...
  project: {
    link: 'https://github.com/vnsoft2014/prisma-client-go',
  },
  chat: {
  ...
  docsRepositoryBase: 'https://github.com/vnsoft2014/prisma-client-go/tree/main/docs',
  footer: {
    text: (
      <span>
        All source code and content licensed under&nbsp;
        <a href="https://github.com/vnsoft2014/prisma-client-go/blob/main/LICENSE" target="_blank">
          Apache 2.0
        </a>
      </span>
    ),
